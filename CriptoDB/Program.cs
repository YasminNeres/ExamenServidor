        ...
        static void CrearContratos()
        {
            using (var db = new CryptoContext())
            {
                ...
                db.Contrato.AddRange(
                    new Contrato { IDcontrato = 1, CarteraId = 1 ,MonedaId = "Bitcoin",  Cantidad = 2},
                    new Contrato { IDcontrato = 2, CarteraId = 1 ,MonedaId = "Litecoin", Cantidad = 3},
                    new Contrato { IDcontrato = 3, CarteraId = 1 ,MonedaId = "Polkadot", Cantidad = 4},
                    new Contrato { IDcontrato = 4, CarteraId = 2 ,MonedaId = "Dogecoin", Cantidad = 3},
                    new Contrato { IDcontrato = 5 ,CarteraId = 2, MonedaId = "ShibaInu", Cantidad = 4},
                    new Contrato { IDcontrato = 6 ,CarteraId = 2, MonedaId = "Litecoin", Cantidad = 3},
                    new Contrato { IDcontrato = 7 ,CarteraId = 3, MonedaId = "Etherum",  Cantidad = 4},
                    new Contrato { IDcontrato = 8 ,CarteraId = 3, MonedaId = "Cardano",  Cantidad = 2},    
                    new Contrato { IDcontrato = 9, CarteraId = 3, MonedaId = "Stellar",  Cantidad = 1},
                    new Contrato { IDcontrato = 10,CarteraId = 3, MonedaId = "Dogecoin", Cantidad = 4},
                    new Contrato { IDcontrato = 11,CarteraId = 4, MonedaId = "Bitcoin", Cantidad = 2},
                    new Contrato { IDcontrato = 12,CarteraId = 4, MonedaId = "ShibaInu", Cantidad = 3},
                    new Contrato { IDcontrato = 13,CarteraId = 4, MonedaId = "Stellar", Cantidad = 4},
                    new Contrato { IDcontrato = 14,CarteraId = 4, MonedaId = "Litecoin", Cantidad = 3},
                    new Contrato { IDcontrato = 15,CarteraId = 5, MonedaId = "Polkadot", Cantidad = 3},
                    new Contrato { IDcontrato = 16,CarteraId = 5, MonedaId = "Cardano" , Cantidad = 1},
                    new Contrato { IDcontrato = 17,CarteraId = 6, MonedaId = "Etherum", Cantidad = 4},
                    new Contrato { IDcontrato = 18,CarteraId = 6, MonedaId = "Litecoin", Cantidad = 2},  
                    new Contrato { IDcontrato = 19,CarteraId = 6, MonedaId = "Polkadot", Cantidad = 1},
                    new Contrato { IDcontrato = 20,CarteraId = 7, MonedaId = "ShibaInu", Cantidad = 2},
                    new Contrato { IDcontrato = 21,CarteraId = 7, MonedaId = "Stellar", Cantidad = 4}
